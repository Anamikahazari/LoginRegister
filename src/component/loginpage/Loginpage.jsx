...
export default function Loginpage() {
  return <div className='flex flex-col justify-center items-center'>
            <div>      
              ...
              <label for="userName" className='cursor-pointer'><i className="fas fa-user colorWhite"></i></label>
            </div>
            <div>  
              ...
              <label for="Password" className='cursor-pointer'><i className="fas fa-unlock-alt colorWhite"></i></label>
            </div>
    </div>;
}
